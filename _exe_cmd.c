 ...
 * Return: is 1 if the path is searchable in the cd, 0 otherwise.
 */
 ...
 *
 * @cmd: is command name
 * @_environ: is the environment variable
 ...
 * Return: it is 0 if is not an executable, other number if it does
 */
 ...
 * @datash: the data structure
 * Return: 1 if  an error exist, 0 if not
 */
